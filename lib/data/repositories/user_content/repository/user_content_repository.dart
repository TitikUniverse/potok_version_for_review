import '../../../data_sources/user_content/remote/user_content_remote_data_source.dart';
...
part 'user_content_repository_impl.dart';

abstract class UserContentRepository {
  factory UserContentRepository() = UserContentRepositoryImpl;
